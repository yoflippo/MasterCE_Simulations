...
plotResultsKF_2d_acc(t,clean,signals,X_arr,velocity,[name]);
figure;
X_arr = rts_smooth(X_arr, P_arr, F, Q);
plotResultsKF_2d_acc(t,clean,signals,X_arr,velocity,[name ' RTS']);
end
