...
plot(ts.t2,  X_arr(:, 1),'Color',[0 0 1], 'LineWidth', 2,'DisplayName','KF result x');
grid on; grid minor; legend
...
plot(ts.t2, X_arr(:, 4),'Color',[0 0 1], 'LineWidth', 2,'DisplayName','KF result y');
grid on; grid minor; legend
...
plot(ts.t2,  X_arr(:, 2),'Color',[0 0 1], 'LineWidth', 2,'DisplayName','KF result velx');
grid on; grid minor; legend
...
plot(ts.t2,  X_arr(:, 5),'Color',[0 0 1], 'LineWidth', 2,'DisplayName','KF result vel y');
grid on; grid minor; legend
