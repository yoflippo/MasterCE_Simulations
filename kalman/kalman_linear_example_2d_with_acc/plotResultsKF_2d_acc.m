function plotResultsKF_2d_acc(t,clean,signals,X_arr,add2title)
...
plot(X_arr(:, 1), X_arr(:, 4),'Color',[0 0 1], ...
    'LineWidth', 2,...
...
plot(t, X_arr(:, 4),'Color',[0.7 0.7 0.1], 'LineWidth', 2,'DisplayName','KF result y');
grid on; grid minor; legend
percentageImprovement = (rmse(signals(1).sig.y-clean.position.y)/rmse(X_arr(:,4)-clean.position.y));
