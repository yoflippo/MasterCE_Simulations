function create_uwb_dummy_data_anchors_rot()
...
posA = 700;
% % % SQUARE
% AnchorLocations = [-posA posA
%     -posA -posA
%     posA posA
%     posA -posA
% ];
% nameCurr = ['_square6_' num2str(posA)];
...
AnchorLocations = (R*AnchorLocations')+2000;
AnchorLocations = [AnchorLocations(:,1:3) [20000 20000]' [-20000 -20000]']+50;
AnchorLocations = AnchorLocations';
% % nameCurr = ['Triangle' num2str(posA/2) 'Rot' num2str(theta)];
nameCurr = ['_square_' num2str(posA)  'Rot' num2str(theta)];
