function CompareSolversRun(numAnchors)
...
% results = CompareSolvers(@executeLarssonTrilateration, 'Larsson',@executeFabertMultiLateration2,'Faber2',blPlot,blSavePlot,blUWBnoise,blPlotClean,blDuration);
% results = CompareSolvers(@executeLarssonTrilateration,'Larsson',@executeFabertMultiLateration2a,'Faber2a',blPlot,blSavePlot,blUWBnoise,blPlotClean,blDuration);
% results = CompareSolvers(@executeLarssonTrilateration,'Larsson',@executeFabertMultiLateration2b,'Faber2b',blPlot,blSavePlot,blUWBnoise,blPlotClean,blDuration);
% results = CompareSolvers(@executeLarssonTrilateration,'Larsson',@executeFabertMultiLateration9,'Faber9',blPlot,blSavePlot,blUWBnoise,blPlotClean),blDuration);
results = CompareSolvers(@executeLarssonTrilateration,'Larsson',@executeVinay1,'Vinay',blPlot,blSavePlot,blUWBnoise,blPlotClean,blDuration);
% results = CompareSolvers(@executeFabertMultiLateration2a,'Faber2a',@executeVinay1,'Vinay',blPlot,blSavePlot,blUWBnoise,blPlotClean,blDuration);
...
stat.infostr.file = replace(stat.infostr.file,',','');
...
if not(blDuration)
    ...
    xlabel(xlab); grid on; grid minor;
    ylabel('%');
    saveas(gcf,[apOutput stat.infostr.file '_DistanceClean_P.png']);
