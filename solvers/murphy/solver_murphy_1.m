...
function locations = solver_murphy_1(distances,ancloc)
...
%% ============================== Nested functions ==============================
    ...
    function out = fi(loc)
        for i = 1:length(ancloc)
            out(i) = sqrt((loc(1)-ancloc(i,1))^2 + (loc(2)-ancloc(i,2))^2) - distances(i);
    ...
    function loc = linearsystem(r,a)
        ...
        aref = a(1,:);
        for i = 2:length(a)
            d(i-1) = ((a(i,1)-aref(1,1))^2) + ((a(i,2)-aref(1,2))^2);
